...
function DashboardNavbar(props) {
  ...
  return (
    <nav className='navbar'>
      ...
      <Link to="/dashboard" className='logo1'><img src='/logo512.png' alt='EventBridge Logo' className='logo' style={{ width: '120px', height: '120px' ,bottom: '100px',top: '0px' ,alignItems: 'center'}}/></Link>
